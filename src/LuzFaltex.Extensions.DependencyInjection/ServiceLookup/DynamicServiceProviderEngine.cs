...
{
    private readonly MutableServiceProvider _serviceProvider;

    public DynamicServiceProviderEngine(MutableServiceProvider serviceProvider): base(serviceProvider)
    {
